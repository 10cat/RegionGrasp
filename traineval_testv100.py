...
def cgrasp_mae(cfg=None):
    ...
    if mode == 'train':
        ...
        trainloader = data.DataLoader(trainset, batch_size=bs, shuffle=True)
        valloader = data.DataLoader(valset, batch_size=bs, shuffle=False)
        # trainloader = data.DataLoader(trainset, batch_size=bs, shuffle=True, batch_sampler=Batchsampler_testv100())
        # valloader = data.DataLoader(valset, batch_size=bs, shuffle=False, batch_sampler=Batchsampler_testv100)
