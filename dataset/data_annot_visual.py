...
if __name__ == "__main__":
    ...
    for idx in tqdm(random_visual_samples, desc=f'{args.ds_name}'):
        ...
        centers = sdf_annot['candidate_centers'][center_ids]
        ...
        for cid, center in enumerate(centers):
            visual_mesh(ObjMesh, bg_color='grey', mark_region=candidates[cid], mark_color='pink')
            visual_mesh_region(ObjMesh, center, 'red')
